                    ...
                    <tbody>
                        @foreach ($all_brand_product as $key => $brand_pro)
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL::to('/edit-brand-product/' . $brand_pro->brand_id)}}" class="active" ui-toggle-class=""><i
                                            class="fa fa-pencil-square-o text-success text-active"></i></a>
                                    <a href="{{URL::to('/delete-brand-product/' . $brand_pro->brand_id)}}" onclick="return confirm('Bạn có thực sự muốn xóa thương hiệu này không?')" class="active" ui-toggle-class=""><i
