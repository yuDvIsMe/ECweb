                    ...
                    <tbody>
                        @foreach ($all_product as $key => $pro)
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL::to('/edit-product/' . $pro->product_id)}}" class="active" ui-toggle-class=""><i
                                            class="fa fa-pencil-square-o text-success text-active"></i></a>
                                    <a href="{{URL::to('/delete-product/' . $pro->product_id)}}" onclick="return confirm('Bạn có thực sự muốn xóa sản phẩm này không?')" class="active" ui-toggle-class=""><i
