                        ...
                        @foreach ($all_category_product as $key => $cate_pro)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{URL::to('/delete-category-product/' . $cate_pro->category_id)}}" onclick="return confirm('Bạn có thực sự muốn xóa danh mục này không?')" class="active" ui-toggle-class=""><i
